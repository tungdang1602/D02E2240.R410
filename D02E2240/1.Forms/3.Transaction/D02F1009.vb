...
Public Class D02F1009

    'tdbg và tdbg2 có Index khác nhau nhưng DataField như nhau => Định nghĩa cùng

#Region "Const of tdbg"
    Private Const COL_TransactionID As Integer = 0    ' TransactionID
    Private Const COL_BatchID As Integer = 1          ' BatchID
    Private Const COL_CipNo As Integer = 2            ' CipNo
    Private Const COL_ModuleID As Integer = 3         ' ModuleID
    Private Const COL_Status As Integer = 4           ' Status
    Private Const COL_Choose As Integer = 5           ' Chọn
    Private Const COL_VoucherTypeID As Integer = 6    ' Loại phiếu
    Private Const COL_VoucherNo As Integer = 7        ' Số phiếu
    Private Const COL_VoucherDate As Integer = 8      ' Ngày phiếu
    Private Const COL_RefDate As Integer = 9          ' Ngày hóa đơn
    Private Const COL_SeriNo As Integer = 10          ' Số Sêri
    Private Const COL_RefNo As Integer = 11           ' Số hóa đơn
    ...
    Private Const COL_Description As Integer = 15     ' Diễn giải
    Private Const COL_DebitAccountID As Integer = 16  ' Tài khoản nợ
    Private Const COL_CreditAccountID As Integer = 17 ' Tài khoản có
    Private Const COL_CurrencyID As Integer = 18      ' Loại tiền
    Private Const COL_ExchangeRate As Integer = 19    ' Tỷ giá
    Private Const COL_OriginalAmount As Integer = 20  ' Số tiền nguyên tệ
    Private Const COL_ConvertedAmount As Integer = 21 ' Số tiền quy đổi
    Private Const COL_VATGroupID As Integer = 22      ' Nhóm thuế
    Private Const COL_VATTypeID As Integer = 23       ' Loại thuế
    Private Const COL_VATNo As Integer = 24           ' Mã số thuế
    Private Const COL_SourceID As Integer = 25        ' Nguồn vốn
    Private Const COL_DivisionID As Integer = 26      ' DivisionID
    Private Const COL_TranMonth As Integer = 27       ' TranMonth
    Private Const COL_TranYear As Integer = 28        ' TranYear
    Private Const COL_Internal As Integer = 29        ' Internal
    Private Const COL_Str01 As Integer = 30           ' Str01
    Private Const COL_Str02 As Integer = 31           ' Str02
    Private Const COL_Str03 As Integer = 32           ' Str03
    Private Const COL_Str04 As Integer = 33           ' Str04
    Private Const COL_Str05 As Integer = 34           ' Str05
    Private Const COL_Num01 As Integer = 35           ' Num01
    Private Const COL_Num02 As Integer = 36           ' Num02
    Private Const COL_Num03 As Integer = 37           ' Num03
    Private Const COL_Num04 As Integer = 38           ' Num04
    Private Const COL_Num05 As Integer = 39           ' Num05
    Private Const COL_Date01 As Integer = 40          ' Date01
    Private Const COL_Date02 As Integer = 41          ' Date02
    Private Const COL_Date03 As Integer = 42          ' Date03
    Private Const COL_Date04 As Integer = 43          ' Date04
    Private Const COL_Date05 As Integer = 44          ' Date05
    Private Const COL_Ana01ID As Integer = 45         ' Ana01ID
    Private Const COL_Ana02ID As Integer = 46         ' Ana02ID
    Private Const COL_Ana03ID As Integer = 47         ' Ana03ID
    Private Const COL_Ana04ID As Integer = 48         ' Ana04ID
    Private Const COL_Ana05ID As Integer = 49         ' Ana05ID
    Private Const COL_Ana06ID As Integer = 50         ' Ana06ID
    Private Const COL_Ana07ID As Integer = 51         ' Ana07ID
    Private Const COL_Ana08ID As Integer = 52         ' Ana08ID
    Private Const COL_Ana09ID As Integer = 53         ' Ana09ID
    Private Const COL_Ana10ID As Integer = 54         ' Ana10ID
#End Region


#Region "Const of tdbg2"
    Private Const COL2_TransactionID As Integer = 0    ' TransactionID
    Private Const COL2_BatchID As Integer = 1          ' BatchID
    Private Const COL2_CipNo As Integer = 2            ' CipNo
    Private Const COL2_ModuleID As Integer = 3         ' ModuleID
    Private Const COL2_Status As Integer = 4           ' Status
    Private Const COL2_Choose As Integer = 5           ' Chi phí
    Private Const COL2_IsNotAllocate As Integer = 6    ' Không tính KH
    Private Const COL2_SourceID As Integer = 7         ' Nguồn vốn
    Private Const COL2_VoucherTypeID As Integer = 8    ' Loại phiếu
    Private Const COL2_VoucherNo As Integer = 9        ' Số phiếu
    Private Const COL2_VoucherDate As Integer = 10     ' Ngày phiếu
    Private Const COL2_RefDate As Integer = 11         ' Ngày hóa đơn
    Private Const COL2_SeriNo As Integer = 12          ' Số Sêri
    Private Const COL2_RefNo As Integer = 13           ' Số hóa đơn
    Private Const COL2_ObjectTypeID As Integer = 14    ' Loại đối tượng
    Private Const COL2_ObjectID As Integer = 15        ' Mã đối tượng
    Private Const COL2_ObjectName As Integer = 16      ' Tên đối tượng
    Private Const COL2_Description As Integer = 17     ' Diễn giải
    Private Const COL2_DebitAccountID As Integer = 18  ' Tài khoản nợ
    Private Const COL2_CreditAccountID As Integer = 19 ' Tài khoản có
    Private Const COL2_CurrencyID As Integer = 20      ' Loại tiền
    Private Const COL2_ExchangeRate As Integer = 21    ' Tỷ giá
    Private Const COL2_OriginalAmount As Integer = 22  ' Số tiền nguyên tệ
    Private Const COL2_ConvertedAmount As Integer = 23 ' Số tiền quy đổi
    Private Const COL2_VATGroupID As Integer = 24      ' Nhóm thuế
    Private Const COL2_VATTypeID As Integer = 25       ' Loại thuế
    Private Const COL2_VATNo As Integer = 26           ' Mã số thuế
    Private Const COL2_DivisionID As Integer = 27      ' DivisionID
    Private Const COL2_TranMonth As Integer = 28       ' TranMonth
    Private Const COL2_TranYear As Integer = 29        ' TranYear
    Private Const COL2_Internal As Integer = 30        ' Internal
    Private Const COL2_Str01 As Integer = 31           ' Str01
    Private Const COL2_Str02 As Integer = 32           ' Str02
    Private Const COL2_Str03 As Integer = 33           ' Str03
    Private Const COL2_Str04 As Integer = 34           ' Str04
    Private Const COL2_Str05 As Integer = 35           ' Str05
    Private Const COL2_Num01 As Integer = 36           ' Num01
    Private Const COL2_Num02 As Integer = 37           ' Num02
    Private Const COL2_Num03 As Integer = 38           ' Num03
    Private Const COL2_Num04 As Integer = 39           ' Num04
    Private Const COL2_Num05 As Integer = 40           ' Num05
    Private Const COL2_Date01 As Integer = 41          ' Date01
    Private Const COL2_Date02 As Integer = 42          ' Date02
    Private Const COL2_Date03 As Integer = 43          ' Date03
    Private Const COL2_Date04 As Integer = 44          ' Date04
    Private Const COL2_Date05 As Integer = 45          ' Date05
    Private Const COL2_Ana01ID As Integer = 46         ' Ana01ID
    Private Const COL2_Ana02ID As Integer = 47         ' Ana02ID
    Private Const COL2_Ana03ID As Integer = 48         ' Ana03ID
    Private Const COL2_Ana04ID As Integer = 49         ' Ana04ID
    Private Const COL2_Ana05ID As Integer = 50         ' Ana05ID
    Private Const COL2_Ana06ID As Integer = 51         ' Ana06ID
    Private Const COL2_Ana07ID As Integer = 52         ' Ana07ID
    Private Const COL2_Ana08ID As Integer = 53         ' Ana08ID
    Private Const COL2_Ana09ID As Integer = 54         ' Ana09ID
    Private Const COL2_Ana10ID As Integer = 55         ' Ana10ID
#End Region
    ...
    '    Private Const COL_CipNo As String = "CipNo"                     ' CipNo
    '    Private Const COL_ModuleID As String = "ModuleID"               ' ModuleID
    '    Private Const COL_Status As String = "Status"                   ' Status
    '    Private Const COL_Choose As String = "Choose"                   ' Chi phí
    '    Private Const COL_IsNotAllocate As String = "IsNotAllocate"     ' Không tính KH
    '    Private Const COL_SourceID As String = "SourceID"               ' Nguồn vốn
    ...
    '    Private Const COL_ObjectID As String = "ObjectID"               ' Mã đối tượng
    ...
    '    Private Const COL_OriginalAmount As String = "OriginalAmount"   ' Số tiền nguyên tệ
    '    Private Const COL_ConvertedAmount As String = "ConvertedAmount" ' Số tiền quy đổi
    '    Private Const COL_VATGroupID As String = "VATGroupID"           ' Nhóm thuế
    '    Private Const COL_VATTypeID As String = "VATTypeID"             ' Loại thuế
    '    Private Const COL_VATNo As String = "VATNo"                     ' Mã số thuế
    '    Private Const COL_DivisionID As String = "DivisionID"           ' DivisionID
    '    Private Const COL_TranMonth As String = "TranMonth"             ' TranMonth
    '    Private Const COL_TranYear As String = "TranYear"               ' TranYear
    '    Private Const COL_Internal As String = "Internal"               ' Internal
    '    Private Const COL_Str01 As String = "Str01"                     ' Str01
    '    Private Const COL_Str02 As String = "Str02"                     ' Str02
    '    Private Const COL_Str03 As String = "Str03"                     ' Str03
    '    Private Const COL_Str04 As String = "Str04"                     ' Str04
    '    Private Const COL_Str05 As String = "Str05"                     ' Str05
    '    Private Const COL_Num01 As String = "Num01"                     ' Num01
    '    Private Const COL_Num02 As String = "Num02"                     ' Num02
    '    Private Const COL_Num03 As String = "Num03"                     ' Num03
    '    Private Const COL_Num04 As String = "Num04"                     ' Num04
    '    Private Const COL_Num05 As String = "Num05"                     ' Num05
    '    Private Const COL_Date01 As String = "Date01"                   ' Date01
    '    Private Const COL_Date02 As String = "Date02"                   ' Date02
    '    Private Const COL_Date03 As String = "Date03"                   ' Date03
    '    Private Const COL_Date04 As String = "Date04"                   ' Date04
    '    Private Const COL_Date05 As String = "Date05"                   ' Date05
...
#End Region
    ...
    Dim clsFilterCheck As Lemon3.Controls.FilterCheckCombo 'ID : 224617 - BỔ SUNG Cho phép gọi màn hình THIẾT LẬP DANH MỤC TÀI SẢN CỐ ĐỊNH tại bước hình thành TS
    ...
    Public WriteOnly Property FormState() As EnumFormState
        Set(ByVal value As EnumFormState)
            ...
            bUseAna = LoadTDBGridAnalysisCaption(D02, tdbg, IndexOfColumn(tdbg, "Ana01ID"), tdbg.Splits.Count - 1, True, gbUnicode)
            ...
            If Not bUseSubInfo Then tdbg2.RemoveHorizontalSplit(SPLIT2)
            LoadTDBCombo()
            LoadTDBDropDown()

            'clsFilterCheck = New Lemon3.Controls.FilterCheckCombo

            'clsFilterCheck.UseFilterCheckCombo(tdbcAssetID)
            'clsFilterCheck.SetMultiCheck(tdbcAssetID, True)

            clsFilterDropdown = New Lemon3.Controls.FilterDropdown() 'ID : 214917 - BỔ SUNG CHỨC NĂNG THÊM MỚI PHÂN BỔ KHẤU HAO TRÊN DROPDOWN TÌM KIẾM PHÂN BỔ KHẤU HAO
            clsFilterCombo = New Lemon3.Controls.FilterCombo
            clsFilterCombo.CheckD91 = False
    ...
    Private Sub SetBackColorObligatory()
        ...
        tdbcAssetAccount.EditorBackColor = COLOR_BACKCOLOROBLIGATORY
    ...
    Private Sub LoadtdbcAssetID()
        ...
        strSQL &= "0 As AssignmentTypeID,null As DeprTableName, null As UseDate,'' As Notes,null As DepDate, " & vbCrLf
    ...
    Private Sub LoadTDBCombo()
        ...
        'Load tdbcDepAccount
        LoadDataSource(tdbcAssetAccount, ReturnTableAccountID("AccountStatus = 0 AND GroupID='7'", gbUnicode), gbUnicode)
...
#Region "Events tdbcAssetID with txtAssetName"
    ...
    Private Sub tdbcAssetID_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tdbcAssetID.KeyDown
        ...
        'f.InListID = "25"
        'f.WhereValue = tdbcAssetID.Text
        'f.InWhere = "( AssetName Like '%%' ) And IsCompleted = 0  And DivisionID = " & SQLString(gsDivisionID)
        'f.ShowDialog()
        'tdbcAssetID.SelectedValue = f.OutPut01
        'f.Dispose()
    ...
    Private Sub tdbcAssetID_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcAssetID.SelectedValueChanged
        ...
        If L3String(tdbcAssetID.SelectedValue) = "+" Then 'ID : 224617 - BỔ SUNG Cho phép gọi màn hình THIẾT LẬP DANH MỤC TÀI SẢN CỐ ĐỊNH tại bước hình thành TS
            ShowD02F0087()
        End If
        ...
        bLoadGrid1 = False
        tdbcAssetAccount.SelectedValue = tdbcAssetID.Columns("AssetAccountID").Value
...
#Region "Event tdbcManagementTypeOBjID"
    ...
    Private Sub tdbcManagementObjTypeID_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles tdbcManagementObjTypeID.LostFocus
        If tdbcManagementObjTypeID.FindStringExact(tdbcManagementObjTypeID.Text) = -1 OrElse tdbcManagementObjTypeID.SelectedValue Is Nothing Then
            ...
            LoadDataSource(tdbcManagementObjTypeID, LoadObjectID(""), gbUnicode)
            tdbcManagementObjTypeID.Text = ""
            Exit Sub
        End If
    End Sub
...
#Region "Events tdbcAssetAccount và tdbcDepAccountID"
    ...
    Private Sub tdbcAssetAccount_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tdbcAssetAccount.LostFocus
        If tdbcAssetAccount.FindStringExact(tdbcAssetAccount.Text) = -1 Then tdbcAssetAccount.Text = ""
    End Sub

    Private Sub tdbcAssetAccount_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tdbcAssetAccount.SelectedValueChanged, tdbcDepAccountID.SelectedValueChanged
    ...
    Private Sub LoadTDBGrid1(Optional ByVal bClear As Boolean = False)
        ...
        Else
            ...
            sSQL = "Select convert(bit,0) as Choose, TransactionID, DivisionID, D02T0012.ModuleID, AssetID, VoucherTypeID, VoucherNo, VoucherDate," & _
                    ...
                    "Ana01ID, Ana02ID, Ana03ID, Ana04ID, Ana05ID,Ana06ID, Ana07ID, Ana08ID, Ana09ID , Ana10ID,Convert(bit,IsNotAllocate) As IsNotAllocate " & vbCrLf
            ...
            sSQL &= "Where DivisionID=" & SQLString(gsDivisionID) & " And  TranMonth + TranYear * 100 <= " & giTranMonth & "+" & giTranYear & "*100" & _
             ...
             " AND ISNULL(CipID,'') = ''"
            If tdbcAssetAccount.Text <> "" Or tdbcDepAccountID.Text <> "" Then
                sSQL &= "  And (DebitAccountID = " & SQLString(ReturnValueC1Combo(tdbcAssetAccount)) & "  OR (CreditAccountID = " & SQLString(ReturnValueC1Combo(tdbcAssetAccount)) & " AND DebitAccountID = " & SQLString(ReturnValueC1Combo(tdbcDepAccountID)) & ") OR CreditAccountID = " & SQLString(ReturnValueC1Combo(tdbcDepAccountID)) & ")"
            End If
...
#Region "Events of Grid1"
    ...
    Private Sub tdbg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tdbg.KeyPress
        Select Case tdbg.Col
            Case IndexOfColumn(tdbg, "Choose") 'Chặn Ctrl + V trên cột Check
                e.Handled = CheckKeyPress(e.KeyChar)
                'Case IndexOfColumn(tdbg, "ConvertedAmount"), IndexOfColumn(tdbg, "OriginalAmount")
...
#Region "Events of Grid2"
    ...
    Private Sub LockServiceLife()
        ...
        If dr.Length > 0 Then
            UnReadOnlyControl(True, txtServiceLife)
        Else
    ...
    Private Sub tdbg2_BeforeDelete(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.CancelEventArgs) Handles tdbg2.BeforeDelete
        ...
        dr.Item("Choose") = 0
        dr.Item("SourceID") = dr.Item("O" & "SourceID")
    ...
    Private Sub HeadClick2(ByVal index As Integer)
        Select Case index
            Case IndexOfColumn(tdbg2, "SourceID"), IndexOfColumn(tdbg2, "Str01") To IndexOfColumn(tdbg2, "Date01")
                CopyColumns(tdbg2, index, tdbg2.Columns(index).Text, tdbg2.Row)
            Case IndexOfColumn(tdbg2, "Choose")
    ...
    Private Sub tdbg2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tdbg2.KeyPress
        Select Case tdbg2.Col
            Case IndexOfColumn(tdbg2, "Choose")  'Chặn Ctrl + V trên cột Check
                e.Handled = CheckKeyPress(e.KeyChar)
                'Case IndexOfColumn(tdbg2, "ConvertedAmount"), IndexOfColumn(tdbg2, "OriginalAmount")
                '    e.Handled = CheckKeyPress(e.KeyChar, EnumKey.NumberDot)
...
#End Region
    ...
    Private Sub LoadTDBGrid2(Optional ByVal bClear As Boolean = False)
        ...
        Else
            ...
            Dim sSQL As String = "Select CONVERT(bit, case when TransMode='CP' then 1 else 0 end) as Choose, TransactionID, DivisionID, ModuleID, SplitNo,AssetID,VoucherTypeID,VoucherNo,VoucherDate,TranMonth,TranYear," & _
                    ...
                    "Date04,Date05,PeriodID,ItemName" & sUnicode & " as ItemName,GroupID,TransMode,Cancel,Convert(bit,IsNotAllocate) As IsNotAllocate " & vbCrLf
            sSQL &= " From D02T0012 WITH(NOLOCK) " & vbCrLf
            sSQL &= "Where TransactionTypeID in('MMDD', 'SDMMDD') And AssetID= " & SQLString(tdbcAssetID.Text) & " Order by TransactionID"
    ...
    Private Sub LoadTDBGrid3(Optional ByVal bClear As Boolean = False)
        ...
        Else
            ...
            strSQL &= " Where D02T5000.HistoryTypeID = 'AS' " 'Bo BeginYear,BeginMonth theo Incident 79529
    ...
    Private Sub LoadEdit()
        ...
        ReadOnlyControl(tdbcAssetID, tdbcAssetAccount, tdbcDepAccountID)
        LoadMasterAssetID()
    End Sub
        ...
        Select Case e.Column.DataColumn.DataField
            Case COL3_AssignmentID
                ...
                If clsFilterDropdown.IsNewFilter Then
                    If tdbg3.Columns(e.ColIndex).Text = "+" Then 'ID : 214917 - BỔ SUNG CHỨC NĂNG THÊM MỚI PHÂN BỔ KHẤU HAO TRÊN DROPDOWN TÌM KIẾM PHÂN BỔ KHẤU HAO
...
#Region "Events of Textbox"
    ...
    Private Sub txtPercentage_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPercentage.Validated
        'DepreciatedAmount = ConvertedAmount * Percentage / 100
        txtDepreciateAmount.Text = SQLNumber((Number(txtConvertedAmount.Text)) * Number(txtPercentage.Text) / 100, DxxFormat.D90_ConvertedDecimals)
    End Sub

    Private Sub txtServiceLife_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtServiceLife.Validated
        'DepreciatedPeriod = AmountDepreciation * DepreciatedPeriod) / ConvertedAmount
...
#End Region
    ...
    Private Function SQLUpdateD02T0012_Delete() As StringBuilder
        ...
        Dim strSQL As String = "SELECT * FROM D02T0012 WITH(NOLOCK)  WHERE(AssetID = " & SQLString(ReturnValueC1Combo(tdbcAssetID)) & ") And " & _
                                " TransactionTypeID in ('MMDD', '') And (DivisionID = '" & gsDivisionID & "') "
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Select Case _FormState
            Case EnumFormState.FormAdd
                ...
                sSQL.Append(SQLInsertD02T5000(sHistoryAAC, giTranMonth, giTranYear, "AAC", , , , , , , , , , , tdbcAssetAccount.Text).ToString)
                ...
                sSQL.Append(SQLInsertD02T5010(sHistoryAAC, "AAC", tdbcAssetAccount.Text))
        ...
        If bRunSQL Then
            ...
            End If
            Dim strSQL As String = ""
            strSQL = "If Not Exists (Select Top 1 1 From D02T0001 With(NoLock) Where AssetID = " & SQLString(tdbcAssetID.Text)
            strSQL &= " And SupplierOTID = '' And SupplierID = '')" & vbCrLf
            strSQL &= "Begin Update D02T0001 Set SupplierOTID = " & SQLString(sObjectTypeID) & ", SupplierID = " & SQLString(sObjectID) & vbCrLf
            strSQL &= "Where AssetID = " & SQLString(tdbcAssetID.Text) & " End"
    ...
    Private Function AllowSave() As Boolean
        ...
        If tdbcAssetAccount.Text.Trim = "" Then
            D99C0008.MsgNotYetChoose(rL3("Tai_khoan_TS"))
            tdbcAssetAccount.Focus()
            Return False
        End If
        ...
        For i As Integer = 0 To tdbg2.RowCount - 1
            If tdbg2(i, COL2_OriginalAmount).ToString = "" Then
                ...
                tdbg2.Col = IndexOfColumn(tdbg2, "OriginalAmount")
                tdbg2.Bookmark = i
                Return False
            End If
            If tdbg2(i, COL2_SourceID).ToString = "" Then
                ...
                tdbg2.Focus()
                tdbg2.SplitIndex = SPLIT1
                tdbg2.Col = IndexOfColumn(tdbg2, "SourceID")
                tdbg2.Bookmark = i
                Return False
            End If
        Next
        'Kh¤ng câ TK Ní nªo ¢§íc ¢Ünh kho¶n giçng TK tªi s¶n!
        Dim dr2() As DataRow = dtGrid2.Select("DebitAccountID= " & SQLString(tdbcAssetAccount.Text))
        If dr2.Length = 0 Then
            D99C0008.MsgL3(rL3("Khong_co_TK_no_nao_duoc_dinh_khoan_giong_TK_tai_san"))
            tabMain.SelectedTab = tabPage2
            tdbg2.Focus()
            tdbg2.SplitIndex = SPLIT1
            tdbg2.Col = IndexOfColumn(tdbg2, "DebitAccountID")
            tdbg2.Row = 0
            Return False
        End If
        ...
        If dConvertedAmo <> Number(txtConvertedAmount.Text) Then
            ...
            tdbg2.Focus()
            tdbg2.SplitIndex = SPLIT1
            tdbg2.Col = IndexOfColumn(tdbg2, "ConvertedAmount")
            tdbg2.Row = 0
            Return False
        End If
    ...
    Private Sub btnNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNext.Click
        ...
        tdbcAssetID.SelectedValue = ""
        tdbcAssetAccount.SelectedValue = ""
    ...
    Private Sub Loadlanguage()
        '================================================================ 
        Me.Text = "CËp nhËt th¤ng tin ¢iÒu ¢èng vçn TSC˜" & " - D02F1009" & UnicodeCaption(gbUnicode) 'CËp nhËt th¤ng tin mua mìi TSC˜ - D02E1009
        '================================================================ 
        ...
        tdbcAssetAccount.Columns("AccountID").Caption = rL3("Ma") 'Mã
        tdbcAssetAccount.Columns("AccountName").Caption = rL3("Ten") 'Tên
    ...
    Private Function SQLUpdateD02T0012s() As StringBuilder
        ...
        For i As Integer = 0 To tdbg2.RowCount - 1
            ...
            If tdbg2(i, COL2_DebitAccountID).ToString = ReturnValueC1Combo(tdbcDepAccountID).ToString And tdbg2(i, COL2_CreditAccountID).ToString = ReturnValueC1Combo(tdbcAssetAccount).ToString Then
                sSQL.Append("TransactionTypeID = " & SQLString("SDMMDD") & COMMA) 'varchar[20], NULL
            Else
                sSQL.Append("TransactionTypeID = " & SQLString("MMDD") & COMMA) 'varchar[20], NULL
            End If
    ...
    Private Function SQLUpdateD02T0001() As StringBuilder
        ...
        sSQL.Append("AssetAccountID = " & SQLString(ReturnValueC1Combo(tdbcAssetAccount)) & COMMA) 'varchar[20], NULL
    ...
    Private Function SQLInsertD02T5000(ByVal sHistoryID As String, ByVal iBeginMonth As Object, ByVal iBeginYear As Object,
        ...
        If ReturnValueC1Combo(tdbcManagementObjTypeID) <> "" AndAlso L3String(sHistoryTypeID) = "OB" Then
    ...
    '# Created User: 
    '# Created Date: 18/11/2021 09:07:30
    '#---------------------------------------------------------------------------------------------------
...
#End Region
    ...
    Public Function CallTotalAmount(Optional ByRef dDepreciatedAmount As Double = 0) As Double
        ...
        For i As Integer = 0 To tdbg2.RowCount - 1
            'Tính Nguyên tệ
            If tdbg2(i, COL2_DebitAccountID).ToString = ReturnValueC1Combo(tdbcAssetAccount).ToString Then
